...
//        mworking.setText(laboratoryModel.getOpening_days() + "  " + laboratoryModel.getOpening_time());
        ...
        mviewmap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lati.equals("") || lati.isEmpty() || lati.equals(null)){
                    Toast.makeText(HospitalDetailsActivity.this,"Location not found..", Toast.LENGTH_SHORT).show();
                } else {

                    if(laboratoryModel.getLat().isEmpty()||laboratoryModel.getLongi().isEmpty()){
                        Toast.makeText(HospitalDetailsActivity.this, "Location Details Not Found....", Toast.LENGTH_SHORT).show();
                    }else{
                        Log.v("??Error","http://maps.google.com/maps?saddr="+Latitude + "," + Longitude+ "&daddr=" + Double.parseDouble(laboratoryModel.getLat()) + "," + Double.parseDouble(laboratoryModel.getLongi())+","+laboratoryModel.getPlace());

                        String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?saddr=" + Latitude + "," + Longitude+ "&daddr=" + Double.parseDouble(laboratoryModel.getLat()) + "," + Double.parseDouble(laboratoryModel.getLongi()) + ","+ laboratoryModel.getPlace());
                        ...
                        catch(ActivityNotFoundException ex)
                        {
                            ...
                            {
                                Toast.makeText(HospitalDetailsActivity.this, "Please install a maps application", Toast.LENGTH_LONG).show();
                            }
                        }
