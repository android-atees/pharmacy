...
public class OtcOrderDetailsModel implements Serializable {
    ...
    public String getOrder_str_id() {
        return order_str_id;
    }

    public void setOrder_str_id(String order_str_id) {
        this.order_str_id = order_str_id;
    }
