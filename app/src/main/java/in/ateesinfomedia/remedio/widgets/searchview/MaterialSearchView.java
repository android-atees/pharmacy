package in.ateesinfomedia.remedio.widgets.searchview;

/**
 * Created by Android-1 on 4/10/2017.
 */
...
import in.ateesinfomedia.remedio.widgets.searchview.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public interface OnQueryTextListener {
         ...
         * SearchView perform the bg_splash_screen action.
         */
         ...
         * @return false if the SearchView should perform the bg_splash_screen action of showing any
    ...
    public void setTintView(){
        if (mTintView.getVisibility() == View.GONE){
            mTintView.setVisibility(View.VISIBLE);
        }
    }
    public void hideTintView(){
        if (mTintView.getVisibility() == View.VISIBLE){
