...
public class ColorSpinnerAdapter extends BaseAdapter {
    ...
    public ColorSpinnerAdapter(Context applicationContext, ArrayList<ConfigValues> sizeValues) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.holder_spinner_color, null);
        TextView names = (TextView) view.findViewById(R.id.spinner_color_txt);
