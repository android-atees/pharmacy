...
public class AgeSpinnerAdapter extends BaseAdapter {
    ...
    public AgeSpinnerAdapter(Context applicationContext, ArrayList<ConfigValues> sizeValues) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.holder_spinner_age, null);
        TextView names = (TextView) view.findViewById(R.id.spinner_age_txt);
